...
class UserAsk(models.Model):
    ...
    course_name=models.CharField(max_length=100,verbose_name=u"咨询课程")
...
class CoueseComments(models.Model):
...
class UserMessage(models.Model):
    ...
    has_red=models.BooleanField(default=False,verbose_name=u"是否已读")
